...
const projects = [
  {
    ...
    description: "A platform that helps individuals find compatible roommates.",
    image: "/projects/project1.png",
    tags: ["React", "TailwindCSS", "Firebase", "MongoDb"],
    demoUrl: "#",
    githubUrl: "#",
  },
  {
    ...
    description:
      "A platform designed to connect individuals who have lost personal belongings with those who may have found them.",
    image: "/projects/project2.png",
    tags: ["Full-stack applications"],
    demoUrl: "#",
    githubUrl: "#",
  },
  {
    ...
    description:
      "Mern stack application with user authentication and payment processing.",
